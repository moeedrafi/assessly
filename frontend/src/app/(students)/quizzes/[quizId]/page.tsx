      ...
      <div className="space-y-2 bg-bg p-6 sm:p-8">
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            ...
            Consequuntur eaque totam, dolores, omnis corrupti consequatur culpa
            provident debitis ipsa maiores ab esse fugiat nulla excepturi modi
            nemo? Cum, odit ipsam!
          </p>
          ...
          <ul className="list-outside pl-4 list-disc space-y-2 text-muted-foreground">
            <li>
              ...
              odit facere asperiores magni laudantium eveniet labore
